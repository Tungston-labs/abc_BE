...
# TOKEN_URL = "https://adminisp.weonebroadband.com/H8IntegrationApi/Token"
# CUSTOMER_URL = "https://adminisp.weonebroadband.com/H8IntegrationApi/CustomerExpiryDetails"
...
#     if not token:
#         raise Exception(
#             f"Unable to fetch WEONE token. Response: {data}"
#         )
...
#     print(f"WEONE Customers Received: {len(normalized)}")
